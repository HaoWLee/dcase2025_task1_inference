...
def parse_args():
    ...
    parser.add_argument("--submission_name", type=str, default="Li_NTU_task1",
                        help="Name of the submission package, e.g., Schmid_CPJKU_task1")
    parser.add_argument("--submission_index", type=int, default=2,
    ...
    #parser.add_argument("--dev_set_dir", type=str, default="F:\dcase_develop_set")
    #parser.add_argument("--eval_set_dir", type=str, default="F:\dcase_evaluation_set")
    parser.add_argument("--dev_set_dir", type=str, default="/home/lihaowen/dcase2025_task1_baseline-main/dataset")
    parser.add_argument("--eval_set_dir", type=str, default="/home/lihaowen/dcase_evaluation_set_2025")
